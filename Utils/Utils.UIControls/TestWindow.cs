...
namespace Utils.UIControls
{
    internal partial class TestWindow : Window
    {
        ...
        public TestWindow(bool canDragMove = true, bool panelItemIsVisible = true)
        {
            //Application.Current.Resources.MergedDictionaries.Clear();

            //ResourceDictionary myResourceDictionary1 = new ResourceDictionary();
            //myResourceDictionary1.Source = new Uri(@"C:\@MyRepos\CustomApp\UIControls\UIControls\UIPresentationControls\Main\NewWindoiwStyle.xaml", UriKind.Absolute);
            ...
            //ResourceDictionary res = (ResourceDictionary)Application.LoadComponent(new Uri(@"C:\@MyRepos\CustomApp\UIControls\UIControls\UIPresentationControls\Main\NewWindoiwStyle.xaml", UriKind.RelativeOrAbsolute));
        ...
        {
            TestWindow mainWindow = (TestWindow)this;
        ...
        static void OpacityActivate(TestWindow mainWindow)
        {
