...
namespace Utils.WinForm.Expander
{
    ...
    public class ExpandCollapsePanelActionList : DesignerActionList
    {
        ...
        public ExpandCollapsePanelActionList(IComponent component)  : base(component)
        {
        ...
        {
            var prop = TypeDescriptor.GetProperties(panel)[propName];
            if (null == prop)
                throw new ArgumentException("Matching ExpandCollapsePanel property not found!", propName);
            else
                return prop;
        }
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            var items = new DesignerActionItemCollection
            {
                ...
                new DesignerActionPropertyItem("IsExpanded",
                    "IsExpanded", "Appearance",
                    "Expand/collapse the panel."),
                new DesignerActionPropertyItem("ButtonStyle",
                    "ButtonStyle", "Appearance",
                    "Visual style of the expand-collapse button."),
                new DesignerActionPropertyItem("ButtonSize",
