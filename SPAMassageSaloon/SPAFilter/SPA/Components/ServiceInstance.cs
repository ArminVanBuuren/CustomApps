...
namespace SPAFilter.SPA.Components
{
	public sealed class ServiceInstance : DriveTemplate, ISAComponent
	{
		...
		public void Refresh()
		{
			...
			var dict = InstanceNode.SelectSingleNode("//context/object[@name='dictionary']/config")
			        ?? InstanceNode.SelectSingleNode("//context/object[@name='dictionary']/fileDictionarySource");
