...
namespace SPAFilter
{
	...
	public partial class SPAFilterForm : Form, ISaloonForm, ISerializable
	{
		...
		void PreInit()
		{
			...
			statusStrip.Items.Add(new ToolStripStatusLabel("Processes:")
			{
				Margin = statusStripItemsPaddingStart
			});
			BPCount = new ToolStripStatusLabel()
			{
			...
			statusStrip.Items.Add(new ToolStripStatusLabel("HostTypes:")
			{
				Margin = statusStripItemsPaddingStart
			});
			NEElementsCount = new ToolStripStatusLabel()
			{
				Margin = statusStripItemsPaddingEnd
			};
			...
			statusStrip.Items.Add(new ToolStripSeparator());
			statusStrip.Items.Add(new ToolStripStatusLabel("Operations:")
			{
				Margin = statusStripItemsPaddingStart
			});
			OperationsCount = new ToolStripStatusLabel()
			{
				Margin = statusStripItemsPaddingEnd
			};
			...
			statusStrip.Items.Add(new ToolStripSeparator());
			statusStrip.Items.Add(new ToolStripStatusLabel("Scenarios:")
			{
				Margin = statusStripItemsPaddingStart
			});
			ScenariosCount = new ToolStripStatusLabel()
			{
				Margin = statusStripItemsPaddingEnd
			};
			...
			statusStrip.Items.Add(new ToolStripSeparator());
			statusStrip.Items.Add(new ToolStripStatusLabel("Commands:")
			{
				Margin = statusStripItemsPaddingStart
			});
			CommandsCount = new ToolStripStatusLabel()
			{
				Margin = statusStripItemsPaddingEnd
			};
		...
		void CallAndCheckDataGridKey(DataGridView grid)
		{
			try
			{
				...
				if (grid == dataGridOperations && !ROBPOperationsRadioButton.Checked)
				{
					...
					OpenEditor(scOperations.OfType<CatalogOperation>()
						           .Select(x => new BlankDocument()
						           {
							           HeaderName = x.Name,
							           BodyText = x.Body,
		...
		public static readonly string[] MandatoryXslxColumns = new string[]
		{
			"#",
			"SPA_SERVICE_CODE",
			"GLOBAL_SERVICE_CODE",
