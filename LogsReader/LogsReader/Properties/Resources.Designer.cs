...
namespace LogsReader.Properties {
    ...
    internal class Resources {
        ...
        ///        Опциональный паттерн: StartTraceWith улучшает скорость поиска, т.к. определяется начало и точные грани трассировки
        ///        Опциональный паттерн: EndTraceWith улучшает скорость поиска, т.к. определяется конец и точные грани трассировки
        ///        Опции StartTraceWi [rest of string was truncated]&quot;;.
        /// </summary>
