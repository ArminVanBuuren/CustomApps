using System;
using Protas.Components.ConditionEx.Collections;
...
{
    internal class Condition : ShellLog3Net
    {
        /// <summary>
        /// Родительское выражение
        /// </summary>
        internal ConditionBlock Parent { get; }
        public Condition(ConditionBlock parent, string firstParam, string secondParam, ConditionOperator _operator, ShellLog3Net log):base(log)
        {
            Parent = parent;
            ParamFirst = new ConditionParameter(firstParam, this);
            ParamSecond = new ConditionParameter(secondParam, this);
            Operator = _operator;
        }
        ...
        bool IsLikesParams(string param1, string param2)
        {
            return ProtasFunk.IsObjectsSimilar(param1, param2);
        }
        bool ParamsIsNotNull(TypeParam pType1, TypeParam pType2)
        {
        ...
        /// </summary>
        ConditionOperator EqualsNumbers(string param1, string param2)
        {
