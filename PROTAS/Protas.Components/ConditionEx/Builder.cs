...
{
    internal class Builder : ShellLog3Net
    {
        IfTarget _parent;
        ConditionBlock _conditionBlock;
        int _parameretId = 0;
        public Builder(ShellLog3Net log) : base(log)
        {
            IfTarget Base = new IfTarget(this)
            {
                LogicalGroup = LogicalGroup.And
            };
            _parent = new IfTarget(this);
        ...
        void LogicalGroupAnd()
        {
            ...
            if (_parent.ChildGroups.Count > 0)
            {
                ...
                {
                    IfTarget newChildBlock = new IfTarget(this);
        ...
        void CreateNewOrBlock()
        {
            ...
            IfTarget newParentBlock = new IfTarget(this);
        ...
        void LogicalGroupIfOpenBkt()
        {
            ...
            if (_parent.StringConstructor != string.Empty)
            {
                ...
                IfTarget newAndChild = new IfTarget(this);
        ...
        private void CreateNewCondition()
        {
            ...
            _conditionBlock = new ConditionBlock(this);
            CreateNewParameters();
        }
